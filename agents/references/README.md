...
Read `AGENTS.md` first, then open only the reference files for the domains the
task touches. Keep this index current when files are added, renamed, or retired.
...
| [repo-layout.md](repo-layout.md) | Rendered workspace shape, repository placement, kustomizations, and pruning. |
| [schemas.md](schemas.md) | `Provision`, `FullProvision`, `PackageDefinition`, and descriptor contracts. |
